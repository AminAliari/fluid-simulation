...
fsl_orbis_root    = os.path.join(forge_root, 'PS4', 'TheForge', 'Tools', 'ForgeShadingLanguage')
fsl_prospero_root = os.path.join(forge_root, 'Prospero', 'TheForge', 'Tools', 'ForgeShadingLanguage')
fsl_xbox_root     = os.path.join(forge_root, 'Xbox', 'TheForge', 'Tools', 'ForgeShadingLanguage')
...
if not 'FSL_COMPILER_DXC' in os.environ:
    os.environ['FSL_COMPILER_DXC'] = os.path.normpath(forge_root+'/TheForge/Graphics/ThirdParty/OpenSource/DirectXShaderCompiler/bin/x64')
